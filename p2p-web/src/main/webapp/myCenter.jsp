            ...
            <div class="eachInvest invest-tab invest-tab-box">
                ...
                <dl>
                    ...
                    <c:forEach items="${rechargeRecordList}" var="rechargeRecord" varStatus="index">
                        <dd>
                            <span class="name">${index.count}</span>
                            <span id="rechargeRecordDesc" >${rechargeRecord.rechargeDesc}</span>
                            <span id="rechargeRecordDescMoney" class="money">${rechargeRecord.rechargeMoney}</span>
                            <span id="rechargeRecordDescTime" class="profit"><fmt:formatDate value="${rechargeRecord.rechargeTime}" pattern="yyyy-MM-dd" /> </span>
                        </dd>
                    </c:forEach>
                </dl>
                <div class="more-allinvest">
                ...
                <dl id="recentearning">
                    ...
                    <c:forEach items="${incomeRecordList}" var="incomeRecord" varStatus="index">
                        <dd>
                            ...
                            <span id="incomeRecordLoanName" class="number">${incomeRecord.loanInfo.productName}</span>
                            <span id="incomeRecordDate" class="number name" style="text-align:center;"><fmt:formatDate value="${incomeRecord.incomeDate}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                            <span id="incomeRecordMoney" class="profit">${incomeRecord.incomeMoney}</span>
                        </dd>
                    </c:forEach>
                </dl>
