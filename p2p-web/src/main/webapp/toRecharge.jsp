    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#weixinpay').click(function () {
                ...
                ${pageContext.request.setAttribute("payType","Wxpay")}
            ...
            $('#alipay').click(function () {
                ...
                <%--${pageContext.request.setAttribute("payType","Alipay")}--%>
                $(this).addClass('img_on').append("<i></i>");
                $(this).parent().siblings().children().removeClass('img_on');
    ...
    <div class="homeWap">
        <div class="fund-guanli clearfix">
            ...
            <div class="right-body">
                ...
                <!-- 充值start -->
                <c:if test="${!empty user.name}">
                    <form id="rechargeForm" action="${pageContext.request.contextPath}/loan/to${pageContext.request.getAttribute("payType")}Recharge" method="post" target="_blank">
