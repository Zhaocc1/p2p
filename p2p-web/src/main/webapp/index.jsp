        ...
        <c:choose>
            <c:when test="${empty user}">
                ...
                <div class="register">
                    ...
                    <div class="bn_register"><a href="register.jsp" class="btn-1">注册领取888理财红包</a></div>
...
<div class="brand-promotion">
    ...
    <div class="mainBox">
        ...
        <div class="jinxin-data">
            ...
            <div class="line"></div>
            <h3>累计成交额</h3>
            <div class="data"><span id="hzxx_ljje">${bidMoney}</span>元</div>
        </div>
    </div>
</div>
<!--品牌宣传end-->
    ...
    <div class="index-exper">
        <div class="inner">
            <div class="index-exper-top">
                <span class="title"><font style="font-size:28px;">${xLoanInfoList.get(0).productName}</font></span>
                <p class="text">${xLoanInfoList.get(0).bidMinLimit}元起投<em>丨
                </em>投资最高限额${xLoanInfoList.get(0).bidMaxLimit}元<em>丨</em>当日计息</p>
            </div>
            <div class="index-exper-bottom <c:if test="${sLoanInfo.leftProductMoney eq 0}">pro-full</c:if>">
                <ul class="list cf">
                    <li class="box1">
                        <p class="text1">${xLoanInfoList.get(0).rate}<span>%</span></p>
                        <p class="text2">历史年化收益率</p>
                    </li>
                    <li class="box2">
                        <p class="text1">${xLoanInfoList.get(0).cycle}<span>天</span></p>
                        <p class="text2">投资周期</p>
                    </li>
                    <li class="box3">
                        <p class="text1">${xLoanInfoList.get(0).leftProductMoney}<span>元</span></p>
                        <p class="text2">剩余可投金额</p>
                    </li>
                    <li class="box4">
                        <a href="loan/loanInfo?id=${xLoanInfoList.get(0).id}" class="go-invest">立即投资</a>
                    </li>
                </ul>
            </div>
        </div>
