                    ...
                    <td>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?ptype=${productType}&currentPage=${currentPage-1}">上一页</a>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?ptype=${productType}&currentPage=${currentPage+1}">下一页 </a>
                                <a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?ptype=${productType}&currentPage=${totalPage}">尾页</a>
                            </c:otherwise>
                        </c:choose>
                    </td>
                </tr>
        ...
        <div class="right-side">
            <div class="side-box fixed" id="roll" style="top: 0px;">
                ...
                <div class="system-notice" style="margin-top: 0px;">
                    ...
                    <ul>
                        <c:forEach items="${bidInfoTopList}" var="topUser" varStatus="index">
