...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            initLoginPage();
            $("#dateBtn1").on("click",getMessageCode);
            ...
            <div class="login-cnt clearfix">
                <div class="login-form">
                    ...
                    <div class="login-box clearfix" style="z-index:10;">
                        <label>账号</label>
                        <input id="phone" name="phone" type="text" class="input_text" placeholder="请输入11位手机号码" maxlength="11" onblur="phoneCheck();"/>
                    </div>

                    <div class="login-box clearfix" style="z-index:8; padding-bottom:0px;">
                        <label>密码</label>
                        <input id="loginPassword" name="loginPassword" type="password" placeholder="请输入登录密码" class="input_text" maxlength="16" onblur="loginPasswordCheck();"/>
                    </div>
                ...
                <div class="login-right">
                    ...
                    <div class="top-txt">
                        动力金融网，便捷的投资平台
                        <br/><br/>
                        加入动力金融网<br/>坐享<span id="historicalAverageRate">--</span>%历史年化收益
                    </div>

                    <div class="currently">
                        平台用户数：<span id="userCount">--</span>位，累计成交额： <span id="bidMoney">--</span>元
                    </div>
